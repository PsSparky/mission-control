      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-bold tracking-wider text-white">MISSION CONTROL</h1>
          </div>
        ...
        <div className="flex items-center gap-12">
          <div className="text-center">
            <div className="text-3xl font-bold text-white">{agentsActive}</div>
            <div className="text-xs text-zinc-500 uppercase tracking-wide mt-1">Agents Active</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-white">{tasksInQueue}</div>
            <div className="text-xs text-zinc-500 uppercase tracking-wide mt-1">Tasks in Queue</div>
          </div>
        </div>
